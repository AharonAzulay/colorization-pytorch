...
parser.add_argument('--val_path', type=str, default='/data/big/dataset/ILSVRC2012')
...
for val_ind in range(1000):
    ...
    os.system('cp %s/validation/ILSVRC2012_val_%08d.JPEG %s/ILSVRC2012_val_%08d.JPEG'%(opt.val_path,val_ind+1,val_path,val_ind+1))
...
for val_ind in val_inds:
    ...
    os.system('cp %s/validation/ILSVRC2012_val_%08d.JPEG %s/ILSVRC2012_val_%08d.JPEG'%(opt.val_path,val_ind+1,test_path,val_ind+1))
