...
cp ./checkpoints/siggraph_retrained/latest_net_G.pth ./checkpoints/siggraph_reg2/
python train.py --name siggraph_reg2 --sample_p .125 --niter 1 --niter_decay 0 --lr 0.000001 --load_model --phase train
